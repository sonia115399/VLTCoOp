...
class ruellia_simplex(DatasetBase):

    dataset_dir = "ruellia_simplex"

    def __init__(self, cfg):
        root = os.path.abspath(os.path.expanduser(cfg.DATASET.ROOT))
        self.dataset_dir = os.path.join(root, self.dataset_dir)
        self.image_dir = os.path.join(self.dataset_dir, "ruellia_simplex")
        self.split_path = os.path.join(self.dataset_dir, "split_ruellia_simplex.json")
