...
class gypsophila_paniculata(DatasetBase):

    dataset_dir = "gypsophila_paniculata"

    def __init__(self, cfg):
        root = os.path.abspath(os.path.expanduser(cfg.DATASET.ROOT))
        self.dataset_dir = os.path.join(root, self.dataset_dir)
        self.image_dir = os.path.join(self.dataset_dir, "gypsophila_paniculata")
        self.split_path = os.path.join(self.dataset_dir, "split_gypsophila_paniculata.json")
