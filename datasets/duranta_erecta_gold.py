...
class duranta_erecta_gold(DatasetBase):

    dataset_dir = "duranta_erecta_gold"

    def __init__(self, cfg):
        root = os.path.abspath(os.path.expanduser(cfg.DATASET.ROOT))
        self.dataset_dir = os.path.join(root, self.dataset_dir)
        self.image_dir = os.path.join(self.dataset_dir, "duranta_erecta_gold")
        self.split_path = os.path.join(self.dataset_dir, "split_duranta_erecta_gold.json")
