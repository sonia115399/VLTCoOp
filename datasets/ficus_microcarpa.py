...
class ficus_microcarpa(DatasetBase):

    dataset_dir = "ficus_microcarpa"

    def __init__(self, cfg):
        root = os.path.abspath(os.path.expanduser(cfg.DATASET.ROOT))
        self.dataset_dir = os.path.join(root, self.dataset_dir)
        self.image_dir = os.path.join(self.dataset_dir, "ficus_microcarpa")
        self.split_path = os.path.join(self.dataset_dir, "split_ficus_microcarpa.json")
