#!/usr/bin/env python3
"""Run/resume the MaPLe few-shot experiments and aggregate results."""
...
def make_jobs(args):
    ...
    for filename in ("trainers/MaPLe/maple_clip.py",
...
def main():
    ...
    if args.dry_run:
        ...
        return 0
    tag = "vit_b16" if args.backbone == "ViT-B/16" else "vit_b32"
    summary_dir = args.output / "_summary" / ("maple_" + tag)
